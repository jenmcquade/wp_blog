...
/*  Copyright 2016 Peter Raschendorfer (email : peter@petersplugins.com)
...
// creates the options page
  function admin_page() {
    ...
    <div class="wrap">
      <?php screen_icon(); ?>
      <h2 style="min-height: 32px; line-height: 32px; padding-left: 40px; background-image: url(<?php echo plugins_url( 'pluginicon.png', __FILE__ ); ?>); background-repeat: no-repeat; background-position: left center"><a href="<?php echo $this->caller->my_url; ?>"><?php echo $this->caller->plugin_name; ?></a> <?php echo __( 'Settings', 'hashtagger' ); ?></h2>
      <hr />
  ...
  function admin_section_tags_title() {
    echo '<p><strong>' . __( 'Tag-Syntax', 'hashtagger' ) . ':</strong></p><hr />';
  }
